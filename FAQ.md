...
## How can I adjust the avatar video?
OBS Studio > File > Settings > Video > 1080x1920 and 360x640.

You can drag around the browser window also.
...
[VRoidHub](https://hub.vroid.com/en/search/*?booth=body&sort=_score) has VRM files to download. Account needed (free).

## Where can I get more animations?
[Mixamo](https://www.mixamo.com/#/?page=1&type=Motion%2CMotionPack) has FBX files to download. Account needed (free).
